public class Main {
        public static void main(String[] args) {
                ...
                if (age >= 18) {
                        ...
                        System.out.printf("Если возраст человека равен %s, он несовершеннолетний\n", age);
                }
                ...
                if (degrees < 5) {
                        ...
                        System.out.printf("На улице %s градусов, cегодня тепло, можно идти без шапки\n", degrees);
                }
                ...
                if (age1 >= 2 && age1 <= 6) {
                        ...
                        System.out.printf("Если возраст человека равен %s, то ему нужно ходить в школу", age1);
                }
